...
class Output(object):
    def __init__(self) -> None:
        ...
        self.high_vwap_diff_time = None
        self.high_vwap_diff = None
        self.high_vwap_diff_price = None
        self.low_price_time = None
        self.low_price = None
        self.low_vwap_diff_time = None
        self.low_vwap_diff = None
        self.low_vwap_diff_price = None
